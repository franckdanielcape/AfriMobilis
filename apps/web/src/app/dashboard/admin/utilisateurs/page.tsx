...
function UtilisateursGlobauxContent() {
    ...
    // Paramètres de filtre géographique (ville/pays) disponibles pour futures améliorations
        ...
        <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
                ...
                <div>
                    ...
                    <p style={{ color: 'var(--text-secondary)', margin: 0 }}>Gestion et vue d&apos;ensemble de tous les comptes de la plateforme</p>
                </div>
            </div>
...
export default function UtilisateursGlobauxPage() {
    return (
        <Suspense fallback={<div style={{ padding: '2rem', textAlign: 'center' }}>Chargement...</div>}>
            <UtilisateursGlobauxContent />
        </Suspense>
    );
}
